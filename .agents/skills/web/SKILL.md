...
This skill covers web-specific RE tools available in the configured WSL environment. Follow the repository rules in `AGENTS.md`; the shared general-purpose tool catalog is in `CLAUDE.md`.
